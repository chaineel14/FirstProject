...
public class ReportConfiguration {
	 ...
	 {
	     String screenshot_path=ReportConfiguration.captureScreenshot(DriverConfig.driver, imagename);
	     String image= logger.addScreenCapture(screenshot_path);
	     ReportConfiguration.logger.log(LogStatus.PASS, ImgDesc, image);
	 }
	 ...
	 public static void FailCase (String failedDetail,String imagename )
	 {
	     String screenshot_path=ReportConfiguration.captureScreenshot(DriverConfig.driver, imagename);
	     String image= logger.addScreenCapture(screenshot_path);
	     ReportConfiguration.logger.log(LogStatus.FAIL, failedDetail, image);
	 }
